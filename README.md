...
* **[konjingjing](https://github.com/ninyawee/konjingjing) (5mo)**
...
* **[national-id-meaning](https://github.com/heypoom/national-id-meaning) (⚠️ 3yr 4mo)** (⚠️ 2yr 9mo)
...
* **[conan](https://github.com/tomhoma/conan) (6mo)** (28d)
  Blazingly fast username scanner written in Rust.

* **[Passkey-Raider](https://github.com/siamthanathack/Passkey-Raider) (⚠️ 1yr 2mo)** (7mo)
...
* **[PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) (4mo)** (11d)
  International phone number OSINT.

* **[TorBot](https://github.com/DedSecInside/TorBot) (4mo)** (2d)
  TOR Network spider bot.

* **[Photon](https://github.com/s0md3v/Photon) (3mo)** (7mo)
  Fast Domain OSINT scraper.

* **[Osintgram](https://github.com/Datalux/Osintgram) (9mo)** (2mo)
  Instagram OSINT.

* **[Xquik](https://github.com/Xquik-dev/x-twitter-scraper) (3d)**
  X (Twitter) data Skill for tweet search, profile timelines, follower export, media, monitoring, webhooks, and MCP.

* **[iKy](https://github.com/kennbroorg/iKy) (7d)** (⚠️ 1yr 3mo)
  Email-based OSINT with futuristic interface.

* **[sn0int](https://github.com/kpcyrd/sn0int) (16d)** (9mo)
  OSINT in RUST with complex domain exploration.

* **[spiderfoot](https://github.com/smicallef/spiderfoot) (1mo)** (10mo)
  Big OSINT.

* **[awesome-osint](https://github.com/jivoi/awesome-osint) (2d)** (3d)
